defmodule EctoDynamicWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(EctoDynamicWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(EctoDynamicWeb.Gettext, "errors", msg, opts)
    end
  end
